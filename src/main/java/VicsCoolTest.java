	...
	public class VicsCoolTest {
	    ...
	    public static void main(String[] args) throws InterruptedException {
	        ...
	        final GpioPinDigitalOutput led1 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_17);
	        final GpioPinDigitalOutput led2 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_27);

	        // provision gpio pin #02 as an input pin with its internal pull down resistor enabled
	        final GpioPinDigitalInput myButton = gpio.provisionDigitalInputPin(RaspiPin.GPIO_22, PinPullResistance.PULL_DOWN);
